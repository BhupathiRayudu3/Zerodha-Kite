...
//creating an application ,here express constructor has been used to create an application
...
app.get('/allPositions',async(req,res)=>{
    //here find is used to fetch database {} empty set is used to fetch all the records,if you want to give params we can give (i.e while using signup,login)
    //await is used to fetch the database
    let allPositions=await PositionsModel.find({});
    res.json(allPositions);
});

// this is the way to dynamically insert dummy data to database
