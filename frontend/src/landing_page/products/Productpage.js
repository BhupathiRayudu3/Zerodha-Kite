...
function Productpage() {
    return (
        <div>
            ...
            <Hero />
            <LeftSection 
            imageURL="media/images/kite.png" heading="Kite" paragraph="Our ultra-fast flagship trading platform with streaming market data, advanced charts, an elegant UI, and more. Enjoy the Kite experience seamlessly on your Android and iOS devices." link1="https://zerodha-web-app-dashboard.vercel.app/" link2="#" name1="Try demo" name2="Learn More" Googleplay="media/images/googlePlayBadge.svg" Appstore="media/images/appstoreBadge.svg" / >
            <RightSection
