...
function Hero() {
  return (
    <div className="container text-center my-5">
      ...
      {/* Content Section */}
      <div className="row border-top pt-5 text-start text-muted">
        {/* Left Column */}
        <div className="col-lg-6 col-12 mb-4 px-3">
          <p>
        ...
        <div className="col-lg-6 col-12 px-3">
          ...
          <p>
            <a href="#" className="text-decoration-none">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups
